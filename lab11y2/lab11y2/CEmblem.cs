...
namespace lab11y2
{
    class CEmblem
    {
        ...
        private void Draw(Pen pen)
        {
            ...
            double r = (Radius);
            Point p1 = new Point(X - (int)(r * Math.Cos(Math.PI / 6)), Y - (int)(r * Math.PI / 6) - Radius*2);
            Point p2 = new Point(X - (int)(r * Math.Cos(Math.PI / 2)), Y + (int)(r * Math.PI / 3) - Radius*2);
            Point p3 = new Point(X + (int)(r * Math.Cos(Math.PI / 6)), Y - (int)(r * Math.PI / 6) - Radius*2);
